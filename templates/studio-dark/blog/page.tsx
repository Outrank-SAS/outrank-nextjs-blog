    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-50">
      <div className="mx-auto w-full max-w-7xl px-4 py-8 md:py-14">
        <header className="mb-10 grid gap-8 md:mb-14 lg:grid-cols-[1fr_20rem] lg:items-end lg:gap-12">
          <div>
            <h1 className="font-serif text-4xl font-black leading-tight text-zinc-50 md:text-6xl">
              {siteConfig.blog.indexTitle}
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-zinc-400">{siteConfig.blog.indexDek}</p>
          </div>
          <BlogSearchField />
        </header>
