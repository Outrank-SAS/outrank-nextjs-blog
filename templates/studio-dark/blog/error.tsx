...
const ErrorBoundary = ({ error, reset }: Props) => {
  ...
  return (
    ...
    >
      ...
      <p className="mt-6 max-w-xl text-lg leading-8 text-zinc-400">{siteConfig.blog.errorDek}</p>
      <div className="mt-8 flex flex-wrap items-center gap-4">
        <button
          type="button"
          onClick={reset}
          className="inline-flex h-10 items-center rounded-md bg-studio-dark-accent px-5 text-sm font-semibold text-white transition hover:bg-studio-dark-accent/90"
        >
