            ...
            <div className="mb-6 flex flex-wrap justify-center gap-2">
              {article.tags.map((tag) => (
                <Link
                  ...
                  className="rounded-full border border-zinc-800 bg-zinc-950 px-3 py-1 text-xs font-bold text-zinc-400 transition hover:border-studio-dark-accent/40 hover:text-studio-dark-accent"
                >
                  {tag}
                </Link>
              ))}
            </div>
            <h1 className="mx-auto max-w-5xl font-serif text-4xl font-black leading-tight text-zinc-50 md:text-6xl">
              {article.title}
            </h1>
