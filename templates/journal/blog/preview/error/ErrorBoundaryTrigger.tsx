...
const ErrorBoundaryTrigger = () => {
  ...
  return (
    <button
      ...
      className="mt-6 rounded-full border border-red-200 bg-red-50 px-4 py-2 text-sm font-medium text-red-700 transition hover:border-red-300 hover:bg-red-100"
    >
