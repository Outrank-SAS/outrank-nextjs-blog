...
const ArticleCardSkeleton = ({ featured = false }: Props) => {
  ...
  return (
    <article className="grid gap-5 border-b border-slate-200 py-9 md:grid-cols-[1fr_24rem] md:gap-10 md:py-10">
      <div className="flex flex-col justify-center">
        <div className="h-3 w-32 animate-pulse rounded-full bg-slate-200" />
      ...
      <div className="relative order-first aspect-[16/9] animate-pulse overflow-hidden rounded-xl bg-slate-200 md:order-none md:aspect-[16/9]" />
    </article>
  );
};
