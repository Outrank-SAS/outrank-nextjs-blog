...
const EmptySearchIllustration = () => (
  ...
  >
    <circle cx="210" cy="160" r="110" fill="rgb(var(--journal-accent) / 0.06)" />

    <g transform="rotate(-8 110 90)">
      <rect x="40" y="50" width="140" height="80" rx="8" fill="white" stroke="rgb(226 232 240)" strokeWidth="1.5" />
      <rect x="52" y="62" width="40" height="40" rx="4" fill="rgb(var(--journal-accent) / 0.12)" />
      <line x1="100" y1="68" x2="168" y2="68" stroke="rgb(var(--journal-accent) / 0.7)" strokeWidth="2.5" strokeLinecap="round" />
    ...
    <g transform="rotate(4 200 230)">
      ...
      <rect x="132" y="202" width="32" height="32" rx="4" fill="rgb(var(--journal-accent) / 0.12)" />
      <line x1="172" y1="208" x2="248" y2="208" stroke="rgb(var(--journal-accent) / 0.7)" strokeWidth="2.5" strokeLinecap="round" />
    ...
    <g>
      <circle cx="240" cy="130" r="52" fill="white" stroke="rgb(var(--journal-accent))" strokeWidth="3" />
      <circle cx="240" cy="130" r="47" fill="rgb(var(--journal-accent) / 0.06)" />
      <line x1="278" y1="168" x2="312" y2="202" stroke="rgb(var(--journal-accent))" strokeWidth="8" strokeLinecap="round" />
      <line x1="316" y1="206" x2="320" y2="210" stroke="rgb(var(--journal-accent))" strokeWidth="8" strokeLinecap="round" />
    </g>

    <g fill="rgb(var(--journal-accent))">
    ...
    <g fill="none" stroke="rgb(var(--journal-accent) / 0.4)" strokeWidth="1.5">
...
const EmptySearchState = ({ query, allArticles }: Props) => {
  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-6 md:p-12">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:gap-12">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          <h3 className="break-words text-2xl font-bold leading-tight tracking-tight text-slate-950 md:text-4xl">
            No articles found for <span className="text-journal-accent">“{truncateQuery(query)}”</span>
          </h3>
