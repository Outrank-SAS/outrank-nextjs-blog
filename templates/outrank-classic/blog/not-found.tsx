...
const NotFound = () => {
  return (
    ...
    >
      ...
      <Link
        href="/blog"
        className="mt-8 inline-flex items-center gap-1.5 text-sm font-semibold text-slate-700 underline-offset-4 transition hover:text-outrank-classic-accent hover:underline"
      >
        <svg
          width="16"
          height="16"
