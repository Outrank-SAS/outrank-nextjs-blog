  ...
  return (
    <div className="relative">
      <input
        ...
        className="peer h-12 w-full rounded-full border border-slate-200 bg-white pl-12 pr-11 text-sm text-slate-900 placeholder:text-slate-400 transition hover:border-slate-300 focus:border-outrank-classic-accent focus:outline-none focus:ring-4 focus:ring-outrank-classic-accent/15 [&::-webkit-search-cancel-button]:appearance-none [&::-webkit-search-decoration]:appearance-none"
      />
      <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 transition-colors peer-focus:text-outrank-classic-accent">
        <SearchIcon />
      </span>
      {searchQuery ? (
        <button
