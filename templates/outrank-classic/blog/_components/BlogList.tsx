      ...
      return (
        <div className="flex flex-col items-center bg-slate-50 px-6 py-16 text-center">
          ...
          <h3 className="mt-5 text-2xl font-black tracking-tight text-slate-950">
            No matches for <span className="text-outrank-classic-accent">“{trimmedQuery}”</span>
          </h3>
          ...
          <Link
            href="/blog"
            className="mt-7 inline-flex items-center rounded-md bg-outrank-classic-accent px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-outrank-classic-accent/90"
          >
            Show all articles
          </Link>
        </div>
