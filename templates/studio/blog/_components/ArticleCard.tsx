...
const ArticleCard = ({ article, imageLoading = 'lazy' }: Props) => {
  return (
    ...
    >
      <article className="flex h-full flex-col rounded-lg border border-slate-200 bg-white p-5 transition duration-200 hover:border-studio-accent/30 hover:bg-studio-accent/5">
        {article.image_url ? (
