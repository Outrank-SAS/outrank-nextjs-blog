    ...
    <article
      className={
        featured
          ...
          : 'group relative flex h-full flex-col overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-sm transition duration-200 hover:border-editorial-accent/15 hover:ring-4 hover:ring-editorial-accent/15'
      }
    >
      {article.image_url ? (
        <div
